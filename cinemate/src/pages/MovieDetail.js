    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
          ...
          <div className="max-w-sm">
            <img className="roundrd" src={image} alt={movie.title} />
          </div>
          <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
            ...
            <p className="my-4">
              <span className="mr-4 font-bold">IMDB Code:</span>
              <a href={`http://www.imdb.com/title/${movie.imdb}`} target="_blank" rel="noreference">{movie.imdb_id}</a>
            </p>
